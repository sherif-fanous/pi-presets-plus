...
**Reason**: The requirement mandates a correction helper, repeated repacking
algorithm, and render result shape that the proposed viewport calculation will
replace. The replacement requirement preserves selected-card visibility without
fixing those implementation details in the contract.

**Migration**: Replace this requirement with the measured viewport behavior
defined by `Picker lays out variable-height cards around the selection`.
